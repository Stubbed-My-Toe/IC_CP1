...
def stats():
    if grade == 1:
        ...
        print("You are a mage.\nThey specialize in longer range magic combat, and have good utility.\nThey deal moderate damage, have low health, and high defense.")
        
    elif grade == 3:
        print("You are a rogue.\nThey specialize in stealth and ambush tactics from close to medium range.\nThey deal high damage, have moderate health, and low defense")
    else:
        print("You need to enter a valid input to access stats!")
